                            ...
                            <template #title>
                                ...
                                <li v-for="value in item.dishes">
                                    ...
                                    <van-grid :column-num="2" style="color:#555">
                                       <van-grid-item v-for="dish in value.dishesBase" style="font-size:12px;">
                                            <template #text>
                                                <div>
                                                    <div><van-image width="100%" height="100%" lazy-load :src="dish.ossurl"/></div>
                                                    <div>
                                                    ...
                                                    <div style="text-align: right">
                                                        <van-icon v-model="dish.num" name="add-o" color="#ee0a24" size="25px" @click="firstAdd(dish)" />
                             ...
                             <div class="cart-item">
                                ...
                                <div>
                                    ...
                                    <van-button type="primary" square color="#009D85" size="normal" @click="gsubmit">去提交</van-button>
                                </div>
                             </div>  
                             ...
                             <van-popup v-model="showInfo" position="center" :style="{ height: '45%',width:'90%' }">
                                <van-cell-group>
                                  <van-cell title="订购菜单">
                                      <template #label>
                                          <ul>
                                            <li v-for="food in carOrderlist.foodlist"> <span>{{food.dishesName}}×{{food.num}}</span></li>
                                          </ul>
                                      </template>
                                  </van-cell>
